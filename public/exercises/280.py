...
# hint: Un número es perfecto si la suma de sus divisores, desde 1 hasta n/2, es igual al propio número.
...
# === TESTS ===
try:
    assert es_numero_perfecto(6) == True, "Error: el 6 es un número perfecto (1+2+3)."
    assert es_numero_perfecto(28) == True, "Error: el 28 debería ser perfecto (1+2+4+7+14)."
