...
# hint: Primero puedes transponer la matriz iterando sobre sus índices y luego recorrerla para filtrar los números pares manteniendo la estructura de filas.
...
try:
    ...
    assert transponer_y_filtrar_pares([[1, 2, 3], [4, 5, 6]]) == [[4], [2, 6], [6]], "Error: considera casos límites en tu lógica."
