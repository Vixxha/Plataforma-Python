...
# hint: Recuerda que un número primo es aquel mayor a 1 que solo es divisible por sí mismo y por 1. Puedes usar un bucle anidado para verificar la divisibilidad.
