...
# hint: Utiliza métodos de strings para convertir a minúsculas y filtra los caracteres no alfanuméricos antes de comparar la cadena con su versión invertida usando slicing [::-1].
