# === METADATA ===
# title: Conteo y Categorización de Votos
# description: Escribe una función que reciba una lista de cadenas con nombres de candidatos que han recibido votos. La función debe retornar un diccionario donde las llaves sean los nombres de los candidatos y los valores sean la cantidad total de votos que obtuvo cada uno.
# difficulty: Básico
