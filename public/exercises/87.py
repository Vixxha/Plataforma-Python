...
# hint: Utiliza métodos de strings como .lower(), .isalnum() o .join() para limpiar la cadena antes de compararla con su versión invertida.
...
try:
    ...
    assert es_palindromo_limpio("Hola, ¿cómo estás?") == False, "Error: considera casos límites en tu lógica."
