...
# hint: Recuerda que la transpuesta de una matriz intercambia las coordenadas [i][j] por [j][i]. Puedes recorrer la matriz por columnas primero para construir la transpuesta y luego aplicar el filtro.
