# === METADATA ===
# title: Analizador de Palíndromos Avanzado
...
# hint: Utiliza el método .isalnum() para filtrar caracteres y considera transformar el string a minúsculas antes de procesarlo.
