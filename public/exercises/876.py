...
# hint: Recuerda que puedes acceder a los elementos de una matriz usando bucles anidados o listas por comprensión, invirtiendo los índices [i][j] a [j][i].
...
try:
    ...
    assert transponer_y_filtrar_pares([[1, 2, 3], [4, 5, 6]]) == [[4], [2, 6], [4]], "Error: considera casos límites en tu lógica."
