...
# hint: Utiliza el método .lower() para estandarizar el texto y .split() para separar las palabras. Puedes iterar sobre la lista resultante e ir actualizando el conteo en el diccionario.
