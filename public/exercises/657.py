...
# hint: Recuerda que un número primo es aquel mayor que 1 que solo es divisible por 1 y por sí mismo. Utiliza un bucle anidado para verificar los divisores de cada número.
