...
# description: Escribe una función que determine si un número entero positivo dado es primo. Un número primo es aquel que solo es divisible por 1 y por sí mismo. El número 1 no se considera primo.
# difficulty: Básico
