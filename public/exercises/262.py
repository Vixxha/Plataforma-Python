...
# hint: Convierte la cadena a minúsculas y usa el método .split() para separar las palabras, luego itera para poblar el diccionario.
...
try:
    ...
    assert contar_palabras("Python es genial y Python es potente") == {'python': 2, 'es': 2, 'genial': 1, 'y': 1, 'potente': 1}, "Error: considera la distinción entre mayúsculas y minúsculas."
