...
# hint: Convierte la cadena a minúsculas usando .lower() y utiliza el método .split() para obtener una lista de palabras.
...
try:
    ...
    assert contar_frecuencia("a a a b") == {'a': 3, 'b': 1}, "Error: el caso base falló."
except NameError:
