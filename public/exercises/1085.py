...
# description: Escribe una función que determine si un número entero positivo es primo. Un número primo es aquel que solo es divisible por sí mismo y por 1. Si el número es menor o igual a 1, debe retornar False.
# difficulty: Básico
