...
# hint: Utiliza un bucle para encontrar todos los números menores que n que lo dividan exactamente (módulo 0), y suma dichos divisores para compararlos con n.
