...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para obtener las palabras. Considera usar un diccionario estándar o collections.Counter.
...
try:
    ...
    assert contar_frecuencias("Python es genial, Python es poderoso") == {'python': 2, 'es': 2, 'genial': 1, 'poderoso': 1}, "Error: considera casos límites en tu lógica."
    assert contar_frecuencias("") == {}, "Error: el caso base (cadena vacía) falló."
except NameError:
