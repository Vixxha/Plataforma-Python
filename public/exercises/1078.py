...
# hint: Puedes recorrer la lista de votos y utilizar el método .get() del diccionario o la estructura collections.Counter para ir acumulando las frecuencias de manera eficiente.
