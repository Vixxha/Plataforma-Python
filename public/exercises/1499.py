...
# description: Escribe una función que determine si un número entero positivo es un número de Armstrong (también conocido como número narcisista). Un número de n dígitos es Armstrong si la suma de cada uno de sus dígitos elevado a la n-ésima potencia es igual al propio número. Por ejemplo, 153 es un número Armstrong porque 1^3 + 5^3 + 3^3 = 1 + 125 + 27 = 153.
# difficulty: Intermedio
# expected_output: True para 153, False para 123
# hint: Puedes convertir el número a cadena (string) para contar fácilmente cuántos dígitos tiene y recorrerlos uno por uno.
