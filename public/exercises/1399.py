...
# expected_output: [[1, 4], [2, 5], [3, 6]] para la entrada [[1, 2, 3], [4, 5, 6]]
# hint: Puedes utilizar listas por comprensión anidadas recorriendo los índices de las columnas y luego las filas, o bien la función zip(*matriz).
