...
# hint: Itera desde 1 hasta la mitad del número (o usa la raíz cuadrada) para encontrar los divisores, y ve sumando aquellos cuyo residuo al dividir sea cero.
