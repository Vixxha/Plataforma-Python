...
# hint: Puedes usar list comprehensions o bucles anidados para recorrer las columnas primero y luego filtrar los valores menores que cero.
...
# === TESTS ===
try:
    assert transponer_y_filtrar([[1, -2, 3], [-4, 5, 6]]) == [[1, 0], [0, 5], [3, 6]] or transponer_y_filtrar([[1, -2, 3], [-4, 5, 6]]) == [[1], [5], [3, 6]], "Error: el test 1 ha fallado."
