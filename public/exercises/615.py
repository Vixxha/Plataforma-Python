...
# hint: Utiliza métodos de string como .lower(), .isalnum() o .join() para limpiar la entrada antes de compararla con su versión invertida.

# === SOLUTION ===
def es_palindromo(texto):
    # Limpiar el texto: dejar solo caracteres alfanuméricos y convertir a minúsculas
    limpio = "".join(char.lower() for char in texto if char.isalnum())
    # Comparar el string limpio con su reverso
