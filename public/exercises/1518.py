...
# hint: Utiliza un bucle para encontrar todos los números menores que n que dividan exactamente a n, y acumula su suma para compararla con el número original.
