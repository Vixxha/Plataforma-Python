...
# hint: Recorre la matriz utilizando dos bucles anidados y compara el valor de la celda actual con su posición opuesta respecto a la diagonal principal.
...
try:
    ...
    assert es_matriz_simetrica([[7]]) == True, "Error: el caso base falló."
except NameError:
