...
# hint: Un divisor propio es cualquier número menor al número dado que lo divide exactamente. Itera desde 1 hasta n//2 para encontrar todos los divisores.
...
# === TESTS ===
try:
    assert es_numero_perfecto(6) == True, "Error: 6 es un número perfecto (1+2+3=6)."
    assert es_numero_perfecto(28) == True, "Error: 28 es un número perfecto (1+2+4+7+14=28)."
