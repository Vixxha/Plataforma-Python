...
# hint: Utiliza el método .isalnum() para filtrar caracteres y considera convertir el string completo a minúsculas antes de comparar.

# === SOLUTION ===
def es_palindromo(cadena):
    limpia = "".join(char.lower() for char in cadena if char.isalnum())
