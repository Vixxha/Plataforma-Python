...
# description: Escribe una función que reciba una lista de nombres de candidatos que han recibido votos. La función debe retornar un diccionario con el recuento de votos de cada candidato y, opcionalmente, podrías contar cuántas veces aparece cada uno. Para este ejercicio, la función debe retornar un diccionario donde las claves sean los nombres de los candidatos y los valores sean la cantidad total de votos obtenidos.
