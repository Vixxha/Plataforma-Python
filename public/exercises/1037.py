...
# hint: Recuerda que para transponer una matriz puedes usar bucles anidados o una comprensión de listas iterando sobre los índices de las columnas y filas. Luego, aplica la condición de número par.
