...
# expected_output: True (para 6, ya que 1 + 2 + 3 = 6) o False (para 12)
# hint: Utiliza un bucle para encontrar todos los números menores que el número dado que dejen residuo cero al dividirlo (divisores propios), y acumula su suma.
