...
# hint: Puedes usar el método .lower() para normalizar el texto y .split() para obtener las palabras, luego itera sobre la lista resultante para llenar el diccionario.
