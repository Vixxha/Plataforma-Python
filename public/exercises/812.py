...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para dividir la cadena en una lista de palabras.
...
try:
    ...
    assert contar_frecuencia("A A A") == {'a': 3}, "Error: el caso base falló."
except NameError:
