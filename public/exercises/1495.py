...
# description: Escribe una función que tome una cadena de texto, cuente cuántas veces aparece cada palabra (ignorando mayúsculas/minúsculas y puntuación básica) y devuelva un diccionario con las frecuencias.
# difficulty: Intermedio
# expected_output: {'hola': 2, 'mundo': 1, 'python': 1}
# hint: Puedes usar .lower() para estandarizar el texto y .split() para separar las palabras, luego recorre la lista actualizando el diccionario.
