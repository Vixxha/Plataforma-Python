...
# description: Implementa una función que determine si un número entero positivo dado es un "número perfecto". Un número perfecto es aquel cuya suma de sus divisores propios (excluyendo el propio número) es igual al número mismo.
# difficulty: Intermedio
# expected_output: True para 6 (1 + 2 + 3 = 6), False para 8.
# hint: Itera desde 1 hasta la mitad del número dado para encontrar sus divisores y súmalos.
