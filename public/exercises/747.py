...
# hint: Puedes usar el método .isalnum() para filtrar caracteres y .lower() para normalizar el texto.
...
try:
    ...
    assert es_palindromo("A man, a plan, a canal: Panama") == True, "Error: considera los signos de puntuación."
