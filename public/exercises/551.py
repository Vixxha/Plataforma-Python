...
# hint: Itera desde 1 hasta la mitad del número dado y acumula aquellos valores que dividan al número de forma exacta (residuo 0).
...
try:
    ...
    assert es_numero_perfecto(28) == True, "Error: 28 debería ser perfecto."
