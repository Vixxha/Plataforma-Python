...
# hint: Utiliza un bucle for para iterar hasta n y un bucle anidado o lógica condicional para verificar si el número tiene divisores distintos a 1 y a sí mismo.
