...
# description: Escribe una función que evalúe si una contraseña cumple con reglas básicas de seguridad: debe tener una longitud mínima de 8 caracteres, contener al menos un dígito numérico y al menos una letra mayúscula. La función debe retornar True si cumple todas las condiciones y False en caso contrario.
# difficulty: Intermedio
# expected_output: True para "Python123", False para "python"
# hint: Utiliza bucles o métodos de cadena como .isupper() y .isdigit() combinados con condicionales.
