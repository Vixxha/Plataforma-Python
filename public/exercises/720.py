...
# hint: Puedes usar el método .isalnum() para filtrar caracteres y .lower() para normalizar la cadena.
...
try:
    ...
    assert es_palindromo("A man, a plan, a canal: Panama") == True, "Error: considera casos límites en tu lógica."
