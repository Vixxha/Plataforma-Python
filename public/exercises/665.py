...
# hint: Convierte la cadena a minúsculas y usa el método .split() para obtener una lista de palabras. Luego, itera sobre la lista y actualiza el diccionario.
...
try:
    ...
    assert contar_frecuencia("Python es genial y Python es facil") == {"python": 2, "es": 2, "genial": 1, "y": 1, "facil": 1}, "Error: considera casos límites en tu lógica."
