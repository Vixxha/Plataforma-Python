...
# hint: Puedes comprobar si el número es divisible por algún entero desde el 2 hasta la raíz cuadrada del número. Recuerda manejar los casos menores o iguales a 1.
