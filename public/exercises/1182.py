...
# hint: Recuerda que un número primo es mayor que 1 y solo es divisible por 1 y por sí mismo. Puedes usar un bucle anidado o una función auxiliar para verificar la primalidad de cada número.
