...
# hint: Convierte el texto a minúsculas, usa el método .split() para obtener una lista de palabras y recorre la lista actualizando los valores en el diccionario.
