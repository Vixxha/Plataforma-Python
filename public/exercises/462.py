...
# description: Crea una función que determine si un número entero positivo es primo. Un número primo es aquel que solo es divisible por 1 y por sí mismo.
# difficulty: Intermedio
# expected_output: True si es primo, False si no lo es.
...
try:
    ...
    assert es_primo(2) == True, "Error: 2 es el único número primo par."
except NameError:
