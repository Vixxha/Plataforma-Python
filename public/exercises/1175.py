...
# hint: Puedes usar los métodos de string como strip(), split() y join(), combinados con title() o capitalizaciones manuales.
...
try:
    ...
    assert formatear_nombre("JUAN   CARLOS   PÉREZ") == "Juan Carlos Pérez", "Error: considera casos límites en tu lógica."
