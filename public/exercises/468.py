...
# description: Crea una función que determine si un número entero positivo dado es un "número perfecto". Un número perfecto es aquel que es igual a la suma de sus divisores propios positivos (excluyéndose a sí mismo).
# difficulty: Intermedio
# expected_output: True para 6 (1 + 2 + 3 = 6), False para 8.
# hint: Iterar desde 1 hasta la mitad del número (o usar la raíz cuadrada para mayor eficiencia) para encontrar los divisores.
