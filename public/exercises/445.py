...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para separar las palabras. Puedes iterar sobre el resultado y actualizar el diccionario manualmente o usar collections.Counter.
