...
# expected_output: {'hola': 2, 'mundo': 1} para el input "Hola mundo hola"
# hint: Usa el método .lower() para normalizar el texto y .split() para obtener las palabras individuales.
