...
# hint: Utiliza el método .isalnum() para filtrar caracteres y .lower() para normalizar el texto antes de comparar la cadena con su versión invertida usando slicing [::-1].
