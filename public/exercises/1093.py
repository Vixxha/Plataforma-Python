...
# difficulty: Básico
# expected_output: 20
# hint: Usa un bucle 'for' para recorrer la lista, un condicional 'if' para verificar si el número es mayor que cero y divisible por dos (num % 2 == 0), y acumula el resultado en una variable.
