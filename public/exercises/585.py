...
# hint: Utiliza el método split() para separar la cadena en una lista de palabras y luego recorre esa lista para extraer el primer carácter de cada una.
...
try:
    ...
    assert generar_acronimo("objeto de aprendizaje") == "ODA", "Error: considera casos límites en tu lógica."
