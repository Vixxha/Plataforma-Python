...
# hint: Usa el método .lower() para normalizar el texto y .split() para separar las palabras. Puedes iterar sobre la lista resultante para llenar el diccionario.
