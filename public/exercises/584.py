...
# hint: Un divisor propio es cualquier número menor que n que divida a n sin dejar residuo. Puedes iterar hasta n // 2.
...
try:
    ...
    assert es_numero_perfecto(8) == False, "Error: el 8 no es un número perfecto (1+2+4=7)."
