...
# hint: Un número es perfecto si la suma de todos sus divisores menores al número es igual al mismo número. Puedes iterar hasta la mitad del número para encontrar divisores.
