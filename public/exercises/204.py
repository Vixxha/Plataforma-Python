...
# description: Crea una función que reciba una cadena de texto, elimine los espacios y signos de puntuación, convierta todo a minúsculas y verifique si es un palíndromo (se lee igual de izquierda a derecha que de derecha a izquierda).
# difficulty: Intermedio
# expected_output: True para "Anita lava la tina", False para "Hola mundo"
# hint: Utiliza el método .isalnum() para filtrar caracteres y considera el slicing [::-1] para invertir la cadena.
