...
# hint: Un número es perfecto si la suma de todos sus divisores menores que él mismo es igual al número original. Considera iterar hasta la mitad del número para optimizar.
