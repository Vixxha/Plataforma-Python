...
# hint: Puedes usar el método .lower() para convertir el texto a minúsculas y .split() para separar las palabras por espacios.
...
try:
    ...
    assert contar_frecuencia_palabras("Hola mundo mundo") == {'hola': 1, 'mundo': 2}, "Error: considera casos límites en tu lógica."
