...
# hint: Considera utilizar el método .lower() para estandarizar el texto y el método .split() para separar las palabras, además de un bucle para iterar y actualizar el diccionario.

# === SOLUTION ===
def contar_frecuencia(texto):
    import re
    # Limpiar el texto eliminando puntuación básica y convirtiendo a minúsculas
