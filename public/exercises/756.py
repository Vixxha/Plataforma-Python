...
# === TESTS ===
try:
    assert procesar_temperaturas([10, -5, 20, 25, -1]) == [18.0, 36.0, 45.0], "Error: el test 1 ha fallado."
    assert procesar_temperaturas([-10, -20]) == [], "Error: considera casos límites en tu lógica."
    assert procesar_temperaturas([0, 100]) == [0.0, 180.0], "Error: el caso base falló."
except NameError:
