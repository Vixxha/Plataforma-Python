...
# hint: Itera desde 1 hasta la mitad del número para encontrar los divisores y acumula su suma.
...
try:
    ...
    assert es_numero_perfecto(1) == False, "Error: el caso 1 no debe ser perfecto."
except NameError:
