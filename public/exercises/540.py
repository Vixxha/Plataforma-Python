...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para obtener una lista de palabras. Puedes iterar sobre la lista y actualizar el diccionario.
...
try:
    ...
    assert contar_frecuencia("Python es genial y Python es divertido") == {'python': 2, 'es': 2, 'genial': 1, 'y': 1, 'divertido': 1}, "Error: considera casos con palabras repetidas."
    assert contar_frecuencia("Solo") == {'solo': 1}, "Error: el caso base falló."
except NameError:
