...
# expected_output: True para 6 (1 + 2 + 3 = 6), False para 4
# hint: Utiliza un bucle para encontrar todos los números menores que n que lo dividan exactamente (módulo 0) y acumula su suma.
