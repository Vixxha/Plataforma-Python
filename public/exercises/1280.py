...
# hint: Utiliza un bucle para encontrar todos los números menores que el número dado que de residuo cero al dividirlo, súmalos y compara el resultado con el número original.
