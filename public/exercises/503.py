...
# hint: Un número no es primo si tiene divisores entre 2 y la raíz cuadrada del mismo número. Recuerda usar un bucle anidado.
...
try:
    ...
    assert filtrar_primos(1) == [], "Error: el caso base (n=1) falló."
except NameError:
