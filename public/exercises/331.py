...
# hint: Utiliza el método .lower() para estandarizar el texto y .split() para separar las palabras. Puedes iterar sobre la lista resultante e ir actualizando el diccionario.
...
try:
    ...
    assert contar_frecuencias("Python es genial y Python es potente") == {'python': 2, 'es': 2, 'genial': 1, 'y': 1, 'potente': 1}, "Error: considera casos límites en tu lógica."
