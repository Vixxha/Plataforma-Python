...
# description: Crea una función que determine si un número entero positivo es "perfecto". Un número perfecto es aquel que es igual a la suma de sus divisores propios positivos (excluyendo al propio número).
# difficulty: Intermedio
# expected_output: True para 6, False para 8
# hint: Un divisor propio de n es cualquier número entre 1 y n-1 que divida a n sin dejar residuo.
