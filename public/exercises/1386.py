...
# hint: Puedes usar list comprehensions o filter para eliminar el stock en 0, la función sorted con una función lambda para ordenar por precio, y otra comprensión para extraer solo los nombres.
...
try:
    inv1 = [
        ...
        {'nombre': 'Manzana', 'precio': 0.8, 'stock': 25},
