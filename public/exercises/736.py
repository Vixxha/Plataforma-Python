...
# hint: Utiliza métodos de string como .isalnum() para filtrar caracteres y .lower() para estandarizar el formato antes de comparar la cadena con su versión invertida.
