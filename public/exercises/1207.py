...
# description: Escribe una función que tome una cadena de texto, la limpie de mayúsculas y devuelva un diccionario donde las claves sean las palabras únicas y los valores representen cuántas veces aparece cada palabra en el texto.
# difficulty: Intermedio
# expected_output: {'python': 2, 'es': 1, 'genial': 1, 'y': 1, 'divertido': 1}
# hint: Puedes usar el método .lower() para estandarizar el texto y .split() para separar las palabras por espacios. Luego, recorre la lista para poblar el diccionario.
