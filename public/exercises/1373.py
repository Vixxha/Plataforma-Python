...
# expected_output: True (para 6) o False (para 10)
# hint: Utiliza un bucle para encontrar todos los números menores que el número dado que dejen residuo 0 al dividirlo, súmalos y compara el resultado con el número original.
