...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para separar las palabras.
...
try:
    ...
    assert contar_frecuencia("Python es genial y Python es facil") == {'python': 2, 'es': 2, 'genial': 1, 'y': 1, 'facil': 1}, "Error: considera casos con palabras repetidas."
