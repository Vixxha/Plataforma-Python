...
# description: Crea una función que determine si un número entero positivo es un 'número perfecto'. Un número perfecto es aquel que es igual a la suma de sus divisores propios positivos, excluyendo al mismo número.
# difficulty: Intermedio
# expected_output: True para 6 (1+2+3), False para 8 (1+2+4=7)
# hint: Itera desde 1 hasta la mitad del número dado y acumula los valores que sean divisores exactos.
