...
# hint: Itera desde 1 hasta n // 2 para encontrar los divisores, acumula aquellos que dividan exactamente a n (usando el operador módulo), y compara la suma total con n.
