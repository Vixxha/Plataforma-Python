...
# hint: Utiliza un bucle para encontrar todos los números menores que el número dado que de tengan residuo cero al dividir, luego súmalos y compáralos con el número original.
