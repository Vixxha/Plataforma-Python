...
# hint: Considera iterar solo hasta la mitad del número o usar la raíz cuadrada para mejorar la eficiencia al buscar divisores.
...
try:
    ...
    assert es_numero_perfecto(28) == True, "Error: considera casos como el 28."
