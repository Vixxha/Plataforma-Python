...
# hint: Puedes usar la comprensión de listas recorriendo los índices de las columnas y luego las filas, o utilizar las funciones built-in de Python combinadas con el operador zip.
