...
# expected_output: [[1, 7], [4, 8]]
# hint: Puedes recorrer las columnas primero y luego las filas para obtener la transpuesta, y usar condiciones para filtrar los elementos no deseados.
...
try:
    ...
    assert transponer_y_filtrar([[1, 3], [7, 8]]) == [[1, 7], [8]], "Error: el caso base falló."
except NameError:
