...
# hint: Utiliza un bucle para encontrar todos los números menores que el número dado que de residuo cero al dividir, súmalos y compara con el número original.
