...
# description: Implementa una función que determine si un número entero positivo es un 'número perfecto'. Un número perfecto es aquel que es igual a la suma de sus divisores propios positivos, excluyendo el número mismo (ejemplo: 6 es perfecto porque 1 + 2 + 3 = 6).
# difficulty: Intermedio
# expected_output: True para 28, False para 12
# hint: Un número perfecto es igual a la suma de sus divisores desde 1 hasta n/2.
