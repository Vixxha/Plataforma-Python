...
# hint: Itera desde 1 hasta la mitad del número (o hasta la raíz cuadrada) para encontrar los divisores y acumular su suma.
...
try:
    ...
    assert es_numero_perfecto(28) == True, "Error: 28 debe ser perfecto."
