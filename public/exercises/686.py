...
# description: Crea una función que reciba una cadena de texto y determine si es un palíndromo, ignorando espacios, signos de puntuación y diferencias entre mayúsculas y minúsculas.
# difficulty: Intermedio
# expected_output: True o False
# hint: Utiliza métodos de string como .lower(), .isalnum() y la técnica de slicing [::-1] para invertir la cadena procesada.
