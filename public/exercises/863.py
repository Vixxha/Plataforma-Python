...
# description: Escribe una función que reciba una matriz cuadrada (representada como una lista de listas) y devuelva una lista con los elementos que se encuentran en su diagonal principal (desde la esquina superior izquierda hasta la inferior derecha).
# difficulty: Intermedio
# expected_output: [1, 5, 9] para la matriz [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
# hint: Los elementos de la diagonal principal son aquellos donde el índice de la fila es igual al índice de la columna (matriz[i][i]).
