...
# hint: Itera desde 1 hasta la mitad del número (o usa la raíz cuadrada para optimizar) acumulando la suma de aquellos números que dividan exactamente al número dado.
