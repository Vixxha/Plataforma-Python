...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para separar las palabras. Puedes usar el método .replace() para eliminar signos de puntuación básicos antes de procesar.
