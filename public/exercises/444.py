...
# hint: Utiliza un método para filtrar caracteres alfanuméricos y otro para normalizar las mayúsculas antes de comparar la cadena con su versión invertida.

# === SOLUTION ===
def es_palindromo(texto):
    # Filtramos solo caracteres alfanuméricos y convertimos a minúsculas
