...
# hint: Utiliza un método para filtrar caracteres no alfanuméricos y convierte todo a minúsculas antes de comparar la cadena original con su versión invertida usando slicing [::-1].
