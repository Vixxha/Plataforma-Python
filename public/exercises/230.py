...
# expected_output: True para 6 (1+2+3), False para 8
# hint: Un divisor es cualquier número que divide al entero original con residuo cero. Considera iterar desde 1 hasta la mitad del número.
...
try:
    ...
    assert es_numero_perfecto(28) == True, "Error: el 28 es un número perfecto conocido."
