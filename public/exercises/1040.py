...
# difficulty: Básico
# expected_output: [6, 12, 18] para la entrada [1, 2, 3, 4, 5, 6]
...
# === TESTS ===
try:
    assert transformar_pares([1, 2, 3, 4, 5, 6]) == [6, 12, 18], "Error: el test 1 ha fallado."
    assert transformar_pares([1, 3, 5]) == [], "Error: considera casos límites en tu lógica."
    assert transformar_pares([-2, 0, 4]) == [-6, 0, 12], "Error: el caso base falló."
except NameError:
