...
# expected_output: True (para 6, ya que 1 + 2 + 3 = 6)
# hint: Utiliza un bucle para encontrar todos los números menores que el número dado que dejen resto 0 al dividirlo, súmalos y compara el resultado con el número original.
