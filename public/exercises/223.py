...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para separar las palabras, luego itera sobre la lista para poblar el diccionario.
...
try:
    ...
    assert contar_palabras("Python es genial y Python es poderoso") == {'python': 2, 'es': 2, 'genial': 1, 'y': 1, 'poderoso': 1}, "Error: considera casos límites en tu lógica."
