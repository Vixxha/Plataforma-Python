...
# hint: Utiliza el método .isalnum() para filtrar caracteres y .lower() para normalizar el texto antes de compararlo con su versión invertida mediante slicing [::-1].
