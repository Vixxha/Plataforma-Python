...
# hint: Utiliza el método .lower() para normalizar el texto y .split() para dividir la cadena en palabras. Puedes iterar sobre la lista resultante e ir actualizando el diccionario.
