...
# hint: Utiliza el método .lower() para normalizar el texto y considera reemplazar los signos de puntuación antes de dividir la cadena con .split().

# === SOLUTION ===
def contar_frecuencia(texto):
    import re
    # Limpiar el texto: quitar signos de puntuación y pasar a minúsculas
